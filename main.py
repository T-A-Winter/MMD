...
def main(l:int, n:int,k:int, path_to_tracks:Path, path_to_features:Path,  run_validation: bool = False, run_on_real_date: bool = False, run_estimate:bool = False, metric: str = "euclidean"):
    if run_validation:
        training_and_validation(path_to_tracks,path_to_tracks,l,n,k,metric)
    if run_on_real_date:
        training_and_validation_merge(path_to_tracks,path_to_tracks,l,n,k,metric)
    if run_estimate:
        data = Data(path_to_features,path_to_tracks) 
...
if __name__ == "__main__":
    ...
    training_and_validation(path_to_tracks, path_to_features, 128, 15, 10, "cosine", verbose=False)
